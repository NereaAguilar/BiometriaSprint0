...
#ifndef BleSecurityMode
  typedef SecureMode_t BleSecurityMode;
#endif

inline void setPermissionSafe(BLECharacteristic &ch, BleSecurityMode permisoRead, BleSecurityMode permisoWrite) {
  ch.setPermission( (SecureMode_t)permisoRead, (SecureMode_t)permisoWrite );
}
...
public:
  ...
  private:
   ...
   setPermissionSafe( this->laCaracteristica, permisoRead, permisoWrite );
  }
 // ()
